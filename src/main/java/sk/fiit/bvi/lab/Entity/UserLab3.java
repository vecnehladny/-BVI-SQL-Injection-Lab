...
@Entity
@Table(name = "users_lab3")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class UserLab3 implements UserMapperInterface {
    @Id
    @Column(name = "id")
    private Long id;
    ...
    public void setProfileIdFromObject(Object o) {
        if (o instanceof String stringProfileId) {
            ...
            throw new IllegalArgumentException("profileId must be of type String for UserLab3");
        }
    }
