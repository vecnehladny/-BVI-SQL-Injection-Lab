...
@Entity
@Table(name = "users_lab5")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class UserLab5 implements UserMapperInterface {
    @Id
    @Column(name = "id")
    private Long id;
    ...
    public void setProfileIdFromObject(Object o) {
        if (o instanceof String stringProfileId) {
            ...
            throw new IllegalArgumentException("profileId must be of type String for UserLab5");
        }
    }
